...
export class SwiftyViewerComponent implements OnInit {
  ...
  downloadPDF(pdf) {
    ...
    if (pdf instanceof ArrayBuffer) {
      linkSource = `data:application/pdf;base64,${this.arrayBufferToBase64(pdf)}`;
  ...
  test() {
    this.downloadPDF(this._base64ToArrayBuffer('JVBERi0xLjcKCjEgMCBvYmogICUgZW50cnkgcG9pbnQKPDwKICAvVHlwZSAvQ2F0YWxvZwog' +
